<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Quản Trị Web - Laravel Shopping</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/cate/danh-sach.html">List Category</a>
                                </li>
                                <li>
                                    <a href="admin/cate/them-cate.html">Add Category</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/san-pham/danh-sach.html">Danh Sách Product</a>
                                </li>
                                <li>
                                    <a href="admin/san-pham/them-san-pham.html">Thêm Product</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
