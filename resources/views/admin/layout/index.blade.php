...
<head>
    ...
    <title>@yield('title') - Laravle Shop</title>
    <base href="{{asset('')}}" />
    <!-- Bootstrap Core CSS -->
    ...
    <!-- DataTables CSS -->
    <link href="ad/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="ad/bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
</head>
...
ad
    ...
    <script src="ad/bower_components/DataTables/media/js/jquery.dataTables.min.js"></script>
    <script src="ad/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>
